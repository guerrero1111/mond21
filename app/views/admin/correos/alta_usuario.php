 ...
 ?> 
	...
	<table border="0" cellspacing="0" cellpadding="0" style="margin:30px auto; background-color:#ffffff; padding:0px; max-width:580px; width:100%">
	  ...
	  <tr>
	    	...
	    	<p style="font-family:'Myriad Pro', 'Myriad Pro Bold', Verdana, Arial; font-size:28px; text-transform: uppercase; color:#000000">Gracias por registrarte a la promoción de YEMINA®... Tus datos de acceso son:</p>
