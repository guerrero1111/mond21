...
//listado de los participantes
 ...
 public function listado_regiones(){
   ...
   if ( $this->session->userdata('session') !== TRUE ) {
        ...
        $data['regiones']   = $this->modelo->get_catalogo_regiones(); 
        //print_r(  $data['regiones'] ); die;

      //$html = $this->load->view( 'catalogos/colores',$data ,true);   
      switch ($id_perfil) {    
        case 1:
            $this->load->view( 'admin/participantes/regiones', $data);
          break;
        case 2:
        case 3:
        case 4:
  ...
  public function procesando_regiones(){

    $data=$_POST;
    //print_r($data); die;
    $busqueda = $this->modelo->buscador_regiones($data);
    echo $busqueda;
  } 
 ...
 public function detalle_regiones($id_participantes,$id_region){
   ...
   if ( $this->session->userdata('session') !== TRUE ) {
      ...
      $data["id_region"] = base64_decode($id_region);
      

      switch ($id_perfil) {    
        case 1:
            $this->load->view( 'admin/participantes/detalle_regiones',$data);
          break;
        case 2:
        case 3:
        case 4:
  ...
  public function procesando_detalle_regiones(){
