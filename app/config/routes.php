...
$route['antitrampa']						= 'home/antitrampa';
...
$route['tiempoinicial']								    = 'home/tiempoinicial';
$route['tiempofinal']								    = 'home/tiempofinal';
$route['validatiempo']								    = 'home/validatiempo';
...
$route['nuevo_usuario']                 = 'home/index';
$route['validar_nuevo_usuario']         = 'home/index';

$route['actualizar_perfil']		         = 'home/index';
...
//regiones
$route['regiones']						= 'main/listado_regiones';
$route['procesando_regiones']			= 'main/procesando_regiones';

//detalle de los participantes
$route['detalle_regiones/(:any)/(:any)']			    = 'main/detalle_regiones/$1/$2';
$route['procesando_detalle_regiones']			= 'main/procesando_detalle_regiones';
